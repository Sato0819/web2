...
$sql = "SELECT * FROM map_table ORDER BY :sort DESC"; //SQL文
...
<script src='https://www.bing.com/api/maps/mapcontrol?callback=GetMap&key=Atb_zXRsJJQ29cgFflpMXbrrK85OhaZofZSZQBIfUZtODrGzu9Y1_rcdhggzXgya' async defer></script>
...
function GetMap(){
    ...
    for(let i=0; i<len; i++){
        ...
        let h='<div style="background-color: #C0C0C0;">'+name[i]+'<br><img src="upload/'+img[i]+'"<br><br>'+naiyo[i]+'</div>';
